          ...
          >
            {toolsData.map((tool, index) => (
              <motion.li
                ...
                className="flex items-center justify-center w-12 sm:w-14 aspect-square border border-gay-400 rounded-lg cursor-pointer hover:translate-y-1 duration-500"
                key={index}
              >
